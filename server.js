...
// NEW: Frontend content API (serves from public)
...
// UPDATED: Admin get content (now from public)
app.get('/api/admin/content', async (req, res) => {
  ...
  try {
    ...
    // CHANGED: Now reading from public instead of public
    const contentPath = path.join(__dirname, 'public', 'content.json');
    const contentData = await fs.readFile(contentPath, 'utf8');
    const content = JSON.parse(contentData);
...
// UPDATED: Admin save content (now to public)
app.post('/api/admin/save-content', async (req, res) => {
  ...
  try {
    ...
    // CHANGED: Now saving to public instead of public
    const contentPath = path.join(__dirname, 'public', 'content.json');
